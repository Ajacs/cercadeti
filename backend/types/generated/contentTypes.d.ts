...
export interface ApiAdAd extends Struct.CollectionTypeSchema {
  collectionName: 'ads';
  info: {
    description: 'Anuncios publicitarios de los negocios';
  ...
  attributes: {
    ...
    click_count: Schema.Attribute.Integer &
...
export interface ApiBusinessPlanBusinessPlan
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    max_ads: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    max_offers: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiBusinessBusiness extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Empresas y negocios registrados en la plataforma';
  ...
  attributes: {
    ...
    contact_form_submissions: Schema.Attribute.Relation<
      'oneToMany',
    ...
    gallery_urls: Schema.Attribute.JSON;
    ...
    offer_text: Schema.Attribute.String;
    ...
    review_count: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    supports_delivery: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categor\u00EDas de negocios y servicios';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    pending_businesses: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: 'Formularios de contacto enviados por usuarios';
    displayName: 'Formularios de Contacto';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    pending_business: Schema.Attribute.Relation<
      'manyToOne',
      'api::pending-business.pending-business'
    >;
    phone: Schema.Attribute.String;
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ofertas especiales de los negocios';
    displayName: 'Ofertas';
    pluralName: 'offers';
    singularName: 'offer';
  };
...
export interface ApiPendingBusinessPendingBusiness
  extends Struct.CollectionTypeSchema {
  collectionName: 'pending_businesses';
  info: {
    description: 'Negocios en espera de aprobaci\u00F3n';
    displayName: 'Negocios Pendientes';
    pluralName: 'pending-businesses';
    singularName: 'pending-business';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    business_plan: Schema.Attribute.Relation<
      'manyToOne',
      'api::business-plan.business-plan'
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_category_name: Schema.Attribute.String;
    description: Schema.Attribute.Text;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pending-business.pending-business': ApiPendingBusinessPendingBusiness;
